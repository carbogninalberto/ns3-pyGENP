...
#include "tcp-gp-reno.h"
#include "ns3/log.h"
#include "ns3/simulator.h"

namespace ns3 {

NS_LOG_COMPONENT_DEFINE ("TcpGpReno");
NS_OBJECT_ENSURE_REGISTERED (TcpGpReno);

TypeId
TcpGpReno::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::TcpGpReno")
    .SetParent<TcpCongestionOps> ()
    .SetGroupName ("Internet")
    .AddConstructor<TcpGpReno> ()
  ;
  return tid;
}

TcpGpReno::TcpGpReno (void) : TcpCongestionOps ()
{
  NS_LOG_FUNCTION (this);
}

TcpGpReno::TcpGpReno (const TcpGpReno& sock)
  : TcpCongestionOps (sock)
{
  NS_LOG_FUNCTION (this);
}

TcpGpReno::~TcpGpReno (void)
{
}

uint32_t
TcpGpReno::SlowStart (Ptr<TcpSocketState> tcb, uint32_t segmentsAcked)
{
...
void
TcpGpReno::CongestionAvoidance (Ptr<TcpSocketState> tcb, uint32_t segmentsAcked)
{
  NS_LOG_FUNCTION (this << tcb << segmentsAcked);
...
void
TcpGpReno::IncreaseWindow (Ptr<TcpSocketState> tcb, uint32_t segmentsAcked)
{
  NS_LOG_FUNCTION (this << tcb << segmentsAcked);
...
std::string
TcpGpReno::GetName () const
{
  return "TcpGpReno";
}

uint32_t
TcpGpReno::GetSsThresh (Ptr<const TcpSocketState> state,
...
void
TcpGpReno::ReduceCwnd (Ptr<TcpSocketState> tcb)
{
...
TcpGpReno::Fork ()
{
  return CopyObject<TcpGpReno> (this);
}
