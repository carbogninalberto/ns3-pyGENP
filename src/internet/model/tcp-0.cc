...
// RENO
NS_LOG_COMPONENT_DEFINE ("TcpNewReno0");
NS_OBJECT_ENSURE_REGISTERED (TcpNewReno0);

TypeId
TcpNewReno0::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::TcpNewReno0")
    .SetParent<TcpCongestionOps> ()
    .SetGroupName ("Internet")
    .AddConstructor<TcpNewReno0> ()
  ;
  return tid;
}

TcpNewReno0::TcpNewReno0 (void) : TcpCongestionOps ()
{
  NS_LOG_FUNCTION (this);
}

TcpNewReno0::TcpNewReno0 (const TcpNewReno0& sock)
  : TcpCongestionOps (sock)
{
  NS_LOG_FUNCTION (this);
}

TcpNewReno0::~TcpNewReno0 (void)
{
}
 ...
 */
uint32_t
TcpNewReno0::SlowStart (Ptr<TcpSocketState> tcb, uint32_t segmentsAcked)
{
 ...
 */
void
TcpNewReno0::CongestionAvoidance (Ptr<TcpSocketState> tcb, uint32_t segmentsAcked)
{
  NS_LOG_FUNCTION (this << tcb << segmentsAcked);
 ...
 */
void
TcpNewReno0::IncreaseWindow (Ptr<TcpSocketState> tcb, uint32_t segmentsAcked)
{
  NS_LOG_FUNCTION (this << tcb << segmentsAcked);
...
std::string
TcpNewReno0::GetName () const
{
  return "TcpNewReno0";
}

uint32_t
TcpNewReno0::GetSsThresh (Ptr<const TcpSocketState> state,
...
void
TcpNewReno0::ReduceCwnd (Ptr<TcpSocketState> tcb)
{
...
TcpNewReno0::Fork ()
{
  return CopyObject<TcpNewReno0> (this);
}
